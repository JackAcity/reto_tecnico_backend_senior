...
El modelo se materializa en [RetoDbContext.cs](../../src/Shared/Persistencia/RetoDbContext.cs). La decisión de mantener una base compartida, sus límites y la alternativa descartada están explicadas en [C10 del diseño](../../openspec/changes/carga-masiva-microservicios/design.md).
