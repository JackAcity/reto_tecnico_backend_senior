...
La topología declarada por el sistema está en [Topologia.cs](../../src/Shared/Mensajeria/Topologia.cs). Para ver la incidencia real de 5M y por qué no se disfraza como éxito, consulte [pruebas de escala](../pruebas-de-escala.md).
