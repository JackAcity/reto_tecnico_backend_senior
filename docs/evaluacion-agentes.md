...
- DIP y separación de BuildingBlocks, Shared, Domain, Application e
  Infrastructure;
...
| Arquitectura | Propone puertos y composiciones respetando DIP. | Hace que Domain use un adaptador o que Shared use BuildingBlocks. |
